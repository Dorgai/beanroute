...
export default function App({ Component, pageProps }) {
    ...
    if ('serviceWorker' in navigator && typeof window !== 'undefined') {
      ...
      navigator.serviceWorker.addEventListener('message', (event) => {
        ...
        if (event.data && event.data.type === 'RELOAD_PAGE') {
          console.log('[PWA] Reload message received - not auto-reloading to prevent infinite refresh');
          // Note: Not auto-reloading to prevent infinite refresh issues
        }
      });
  ...
  // Wrap everything in AuthProvider and CustomThemeProvider
  return (
    <ErrorBoundary>
      <CustomThemeProvider>
        <ThemeProvider>

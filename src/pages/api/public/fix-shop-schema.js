// PUBLIC migration endpoint to fix shop schema
...
export default async function handler(req, res) {
  try {
    ...
    console.log('[public-fix-shop-schema] Starting shop schema migration...');
    ...
    console.log('[public-fix-shop-schema] Existing columns:', existingColumnNames);

    let fieldsAdded = [];

    // Add minCoffeeQuantityEspresso if it doesn't exist
    if (!existingColumnNames.includes('minCoffeeQuantityEspresso')) {
      console.log('[public-fix-shop-schema] Adding minCoffeeQuantityEspresso column...');
    ...
    if (!existingColumnNames.includes('minCoffeeQuantityFilter')) {
      console.log('[public-fix-shop-schema] Adding minCoffeeQuantityFilter column...');
      await prisma.$executeRawUnsafe(`
        ALTER TABLE "public"."Shop" 
    ...
    console.log('[public-fix-shop-schema] Verified columns:', verifiedColumns);
    ...
    console.log('[public-fix-shop-schema] Migration completed successfully!');
    ...
    console.error('[public-fix-shop-schema] Error:', error);

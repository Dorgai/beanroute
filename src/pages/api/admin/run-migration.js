...
export default async function handler(req, res) {
  try {
    ...
    console.log('[run-migration] Starting InventoryEmailNotification table migration...');
    ...
    if (existingTables.length > 0) {
      console.log('[run-migration] Table already exists');
    ...
    console.log('[run-migration] Creating indexes...');
    ...
    console.log('[run-migration] Adding foreign key constraints...');
